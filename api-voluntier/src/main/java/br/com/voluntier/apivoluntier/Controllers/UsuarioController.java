...
public class UsuarioController {
    ...
    public ResponseEntity postEmailExistente(@PathVariable String email){
        ...
        emailSender.sendMessage(
                ...
                "<!DOCTYPE html><html xmlns=\"http://www.w3.org/1999/xhtml\"><head> <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"/> <title>E-mail Recuperação de senha</title> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"/> <link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"> <link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin> <link href=\"https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap\" rel=\"stylesheet\"></head><body style=\"margin: 0; padding: 0; font-family: 'Poppins', sans-serif;\"> <table align=\"center\" style=\"border-collapse: collapse; border: none; height: 100%; width: 100%; margin: 0; padding: 0;\"> <tr> <td> <div style=\"width: 100%; height: 70px; background: #06377B; padding-top: 5px;\"> <span style=\"font-size: 1rem; color: white; width: 10px; margin-left: 10px; margin-top: 10px;\"> Recuperação de senha </span> </div></td></tr><tr align=\"center\"> <td style=\"padding-top: 50px; font-size: 1rem;\"> <span>Olá Vamos recuperar a sua senha basta clicar no botão aqui embaixo!</span> </td></tr><tr align=\"center\"> <td style=\"padding-top: 25px;\"> <a href=\""+linkCompleto+"\"> <button style=\"background: #06377B; border-radius: 8px; width: 150px; height: 40px; color: white; border: none; font-family: 'Poppins', sans-serif; cursor: pointer;\"> Recuperar senha </button> </a> </td></tr></table></body></html>",
                email
        );
        return ResponseEntity.status(200).build();
    }
