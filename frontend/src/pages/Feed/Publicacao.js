            ...
            <div className="container-publicacao">
                    { 
                        publicacoes.map((publicacao) => (
                            ...
                            imgsrc={imgLonga} imgIconLike={imgLike} imgIconComment={imgComment} likes="10" comments="5" userName={publicacao.usuario.nomeUsuario} time={publicacao.evento.dataEvento} desc={publicacao.descricao} tags="#Gratidão #AmoCães" />
                        ))
                    }
            </div>
        );
